...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
    ...
    <div class="lg:col-span-1">
        <div class="bg-white rounded-lg shadow-md p-6 space-y-6">
            ...
            @if($mode === 'create')
                <div>
                    <label class="text-sm font-medium text-slate-700">Arena Name *</label>
            ...
            <div>
                <h4 class="font-medium mb-2">Add Elements</h4>
                <div id="builder-notification" class="builder-notification hidden"></div>
                <div class="element-palette">
                    <button type="button" class="palette-item" data-type="seat">🪑 Seat</button>
                    <button type="button" class="palette-item" data-type="court">🏐 Volleyball Court</button>
                </div>
            </div>

            <div class="bg-slate-50 rounded-3xl border border-slate-200 p-4">
                <h4 class="font-medium mb-3">Generate Seat Grid</h4>
                <div class="grid grid-cols-2 gap-3">
                    <label class="text-sm text-slate-700">Total seats
                    ...
                    <label class="text-sm text-slate-700">Columns
                ...
                <label class="text-sm text-slate-700 mt-3 block">Rows
                ...
                <button id="generate-grid" type="button" class="mt-3 w-full rounded-2xl bg-blue-600 text-white px-4 py-2 hover:bg-blue-700">Generate Seats</button>
            </div>

            <div>
                <h4 class="font-medium mb-2">Grid Size</h4>
            ...
            <div>
                <h4 class="font-medium mb-2">Selected Element</h4>
            ...
            <div class="space-y-2">
                <button id="save-arena" type="button" class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-2xl font-medium">
                    {{ $mode === 'create' ? 'Create Arena' : 'Save Arena' }}
                </button>
    ...
    <div class="lg:col-span-3">
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold">Arena Layout</h3>
