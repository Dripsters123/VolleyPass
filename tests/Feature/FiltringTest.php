...
it('returns matches when filtering by existing team name', function () {
    ...
    $this->seed(\Database\Seeders\LocalMatchSeeder::class); // Aizpilda datubāzi ar testa mačiem
    ...
    // Pārbauda, vai lapa rāda attiecīgās komandas nosaukumu un formātu
...
it('shows the empty-state message when filtering by a non-existent team', function () {
    ...
    $this->seed(\Database\Seeders\LocalMatchSeeder::class); // Aizpilda datubāzi ar testa datiem
